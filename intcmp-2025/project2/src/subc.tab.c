...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ext_def_list = 47,              /* ext_def_list  */
  YYSYMBOL_ext_def = 48,                   /* ext_def  */
  YYSYMBOL_type_specifier = 49,            /* type_specifier  */
  YYSYMBOL_struct_specifier = 50,          /* struct_specifier  */
  YYSYMBOL_func_decl = 51,                 /* func_decl  */
  YYSYMBOL_pointers = 52,                  /* pointers  */
...
{
       0,    56,    56,    63,    67,    74,    78,    82,    86,    93,
      97,   104,   108,   115,   119,   126,   130,   137,   141,   148,
     152,   159,   163,   170,   174,   181,   188,   192,   199,   203,
     207,   211,   215,   219,   223,   227,   231,   235,   242,   246,
     253,   257,   264,   268,   272,   276,   280,   284,   288,   292,
     296,   300,   307,   311,   315,   319,   323,   327,   331,   335,
...
static const char *const yytname[] =
{
  ...
  "LOGICAL_OR", "LOGICAL_AND", "RELOP", "EQUOP", "INCOP", "DECOP",
  "STRUCTOP", "ID", "CHAR_CONST", "STRING", "INTEGER_CONST", "','", "'='",
  "'+'", "'-'", "'*'", "'/'", "'%'", "'!'", "UMINUS", "USTAR", "UAMP",
  "'('", "')'", "'['", "']'", "'.'", "LOWER_THAN_ELSE", "';'", "'{'",
  "'}'", "'&'", "$accept", "program", "ext_def_list", "ext_def",
  "type_specifier", "struct_specifier", "func_decl", "pointers",
  "param_list", "param_decl", "def_list", "def", "compound_stmt",
  "stmt_list", "stmt", "expr_e", "expr", "binary", "unary", "args", YY_NULLPTR
};
...
{
    -119,    36,    46,  -119,  -119,    18,  -119,    -3,    11,    16,
      21,  -119,    33,  -119,  -119,  -119,  -119,   -14,    46,     8,
       1,    45,  -119,    -3,  -119,  -119,    55,  -119,  -119,    -3,
      -8,  -119,    31,    50,  -119,   144,    39,    44,    49,    30,
      40,   144,   144,  -119,  -119,  -119,  -119,   144,   144,   144,
     144,  -119,  -119,   144,  -119,  -119,    47,   176,   159,    60,
      46,  -119,    48,   -19,    52,   144,   144,   144,  -119,  -119,
    -119,  -119,    93,    93,    93,    51,    93,  -119,   144,   144,
     144,   144,   144,   144,   144,   144,   144,  -119,  -119,    65,
     144,   124,   144,    74,    58,  -119,  -119,    77,  -119,  -119,
      73,    79,    80,  -119,  -119,   185,    93,   192,   215,   201,
       5,     5,  -119,  -119,  -119,  -119,  -119,  -119,  -119,    -7,
      82,  -119,    99,    87,    96,    96,   144,   144,  -119,  -119,
      88,    92,   126,  -119,    94,  -119,  -119,  -119,    96,   144,
    -119,   100,    96,  -119
};
...
static const yytype_int8 yydefact[] =
{
      ...
      12,    15,     0,     7,    22,     8,    22,     0,    27,     0,
       0,     0,     5,    16,    10,    21,     0,    11,    13,    16,
       0,    17,     0,     0,    70,     0,     0,     0,     0,     0,
       0,     0,     0,    56,    54,    55,    53,     0,     0,     0,
       0,    31,    25,     0,    29,    26,     0,    41,    51,     0,
       0,    14,     0,     0,     0,     0,     0,    39,    36,    37,
      61,    62,    57,    64,    58,     0,    63,    28,     0,     0,
       0,     0,     0,     0,     0,     0,     0,    59,    60,     0,
       0,     0,     0,     0,    19,    18,     6,     0,    23,    30,
       0,     0,     0,    38,    52,    50,    51,    49,    42,    43,
      44,    45,    46,    47,    48,    67,    40,    69,    71,     0,
       0,    66,     0,     0,     0,     0,    39,     0,    68,    65,
       0,     0,    32,    34,     0,    72,    20,    24,     0,    39,
      33,     0,     0,    35
};
...
{
    -119,  -119,  -119,  -119,    -1,   137,  -119,    25,  -119,    83,
     132,  -119,   141,  -119,  -118,  -113,   -35,   154,   -39,  -119
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     2,     6,    23,    24,     9,    12,    30,    31,
      18,    25,    54,    26,    55,   102,    56,    57,    58,   119
};
...
{
      64,     7,    70,    71,     4,     5,   132,   133,    72,    73,
      74,     4,     5,   134,    76,    75,    60,   127,    97,    29,
     140,    20,    98,    21,   143,    11,   141,    22,    61,   128,
     100,   101,   103,    84,    85,    86,     3,    28,    10,   106,
     106,   106,   106,   106,   106,   106,   106,   106,    33,     4,
       5,    27,    13,    17,    59,   116,   118,   120,    14,    29,
      34,    35,    36,    16,    37,    38,    39,    40,    32,    62,
      63,    68,    41,    42,    65,    43,    44,    45,    46,    66,
      94,    69,    47,    48,    67,   115,    49,   104,    77,    96,
      50,   103,   135,    99,   121,   122,    51,    14,    52,    53,
     123,    34,    35,    36,   103,    37,    38,    39,    40,   124,
      87,    88,    89,    41,    42,   125,    43,    44,    45,    46,
     129,   126,   130,    47,    48,   131,   136,    49,    91,    34,
      92,    50,    93,   137,   138,   139,   142,    51,    14,     8,
      53,    41,    42,    95,    43,    44,    45,    46,    19,    34,
      15,    47,    48,     0,     0,    49,     0,     0,     0,    50,
     117,    41,    42,     0,    43,    44,    45,    46,    53,     0,
       0,    47,    48,     0,     0,    49,    87,    88,    89,    50,
       0,     0,     0,     0,    90,     0,     0,     0,    53,    78,
      79,    80,    81,     0,    91,     0,    92,     0,    93,    79,
      80,    81,    82,    83,    84,    85,    86,    80,    81,     0,
       0,    82,    83,    84,    85,    86,    80,     0,    82,    83,
      84,    85,    86,     0,     0,     0,     0,    82,    83,    84,
      85,    86,   105,   107,   108,   109,   110,   111,   112,   113,
     114,    82,    83,    84,    85,    86
};

static const yytype_int16 yycheck[] =
{
      35,     2,    41,    42,     3,     4,   124,   125,    47,    48,
      49,     3,     4,   126,    53,    50,    24,    24,    37,    20,
     138,    35,    41,    37,   142,    28,   139,    41,    36,    36,
      65,    66,    67,    28,    29,    30,     0,    36,    20,    78,
      79,    80,    81,    82,    83,    84,    85,    86,    23,     3,
       4,    43,    41,    20,    29,    90,    91,    92,    42,    60,
       5,     6,     7,    42,     9,    10,    11,    12,    23,    38,
      20,    41,    17,    18,    35,    20,    21,    22,    23,    35,
      20,    41,    27,    28,    35,    20,    31,    36,    41,    41,
      35,   126,   127,    41,    20,    37,    41,    42,    43,    44,
      23,     5,     6,     7,   139,     9,    10,    11,    12,    36,
      17,    18,    19,    17,    18,    36,    20,    21,    22,    23,
      38,    41,    23,    27,    28,    38,    38,    31,    35,     5,
      37,    35,    39,    41,     8,    41,    36,    41,    42,     2,
      44,    17,    18,    60,    20,    21,    22,    23,    16,     5,
       9,    27,    28,    -1,    -1,    31,    -1,    -1,    -1,    35,
      36,    17,    18,    -1,    20,    21,    22,    23,    44,    -1,
      -1,    27,    28,    -1,    -1,    31,    17,    18,    19,    35,
      -1,    -1,    -1,    -1,    25,    -1,    -1,    -1,    44,    13,
      14,    15,    16,    -1,    35,    -1,    37,    -1,    39,    14,
      15,    16,    26,    27,    28,    29,    30,    15,    16,    -1,
      -1,    26,    27,    28,    29,    30,    15,    -1,    26,    27,
      28,    29,    30,    -1,    -1,    -1,    -1,    26,    27,    28,
      29,    30,    78,    79,    80,    81,    82,    83,    84,    85,
      86,    26,    27,    28,    29,    30
};
...
{
       0,    46,    47,     0,     3,     4,    48,    49,    50,    51,
      20,    28,    52,    41,    42,    57,    42,    20,    55,    55,
      35,    37,    41,    49,    50,    56,    58,    43,    36,    49,
      53,    54,    23,    52,     5,     6,     7,     9,    10,    11,
      12,    17,    18,    20,    21,    22,    23,    27,    28,    31,
      35,    41,    43,    44,    57,    59,    61,    62,    63,    52,
      24,    36,    38,    20,    61,    35,    35,    35,    41,    41,
      63,    63,    63,    63,    63,    61,    63,    41,    13,    14,
      15,    16,    26,    27,    28,    29,    30,    17,    18,    19,
      25,    35,    37,    39,    20,    54,    41,    37,    41,    41,
      61,    61,    60,    61,    36,    62,    63,    62,    62,    62,
      62,    62,    62,    62,    62,    20,    61,    36,    61,    64,
      61,    20,    37,    23,    36,    36,    41,    24,    36,    38,
      23,    38,    59,    59,    60,    61,    38,    41,     8,    41,
      59,    60,    36,    59
};
...
#line 1277 "subc.tab.c"
    break;

  case 7: /* ext_def: struct_specifier ';'  */
#line 83 "subc.y"
  {
    REDUCE("ext_def->struct_specifier ';'");
  }
#line 1285 "subc.tab.c"
    break;
